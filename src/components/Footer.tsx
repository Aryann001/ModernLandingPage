    ...
    >
      ...
      >
        <div className="w-[50%] h-full flex flex-col justify-between box-border">
          ...
          >
            <div className="flex w-1/2 sm:justify-center items-center justify-start">
              <div>
                ...
                <form className="flex gap-[1rem] mt-[3rem] w-full">
                  <input
                    type="text"
            ...
            <div className="flex w-1/2 sm:justify-center items-center justify-start">
              <div>
                ...
                <h2 className="font-paytone flex flex-col font-medium xl:text-5xl sm:text-3xl text-4xl mt-[1rem] leading-[1.2em] tracking-tight text-zinc-900">
                  <a href="mailto:xyz@gmail.com">xyz@gmail.com</a>
                  <a href="tel:78888999">{`+(91)78889xxx`}</a>
                </h2>
                <p className=" font-paytone text-zinc-900/70 font-semibold mt-[1.5rem] sm:text-base text-3xl leading-[1.2em] tracking-tighter">
          ...
          <motion.div
            style={{ translateY: parallaxDiv }}
            className="flex sm:flex-row flex-col justify-between mx-[3rem] py-[3rem] border-t-2 border-blue-950/15"
          >
            <div className="flex xl:gap-[1rem] gap-[0.5rem] font-montserrat uppercase font-semibold tracking-[0.25em] xl:text-[0.55rem] text-[0.35rem] items-center justify-center text-blue-950">
              <p>Privacy Policy</p>
              <p>Disclaimer</p>
            ...
            {/*  */}
            <div className="flex xl:gap-[1rem] gap-[0.5rem] font-montserrat uppercase font-semibold tracking-[0.25em] xl:text-[0.55rem] text-[0.35rem] items-center justify-center">
